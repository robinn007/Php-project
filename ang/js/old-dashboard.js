/**
 * @file dashboard.js
 * @description Defines the DashboardController for the Student Management System.
 * Displays an overview of active and deleted students.
 */
 ...
 * @param {Object} AuthService - Service for authentication operations
 * @param {Object} $location - Angular location service
 */


app.controller('DashboardController', ['$scope', 'StudentService', 'AuthService', '$location', function($scope, StudentService, AuthService, $location) {
  ...
  StudentService.getStudents().then(function(response) {
    ...
    // Sort students by created_at and take the 5 most recent
  ...
  /**
    ...
    @description Navigates to the edit student page for a specific student.
  ...
  $scope.goToStudents = function() {
   ...
   /**
   * @function goToDeletedStudents
   * @description Navigates to the deleted students archive page.
   */
